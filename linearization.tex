...
\begin{multline}
    \sa c \beta (e^{n+1} - e^k) = \frac{\frac{1}{2}\sigma_a a c \Dt \frac{\beta}{\rho}}{1
...
equations, includeing an effective scattering cross section given by $\sigma_a \nu$.  After
solving for $\ER^{n+1,k+1}$, a new internal energy can be estimated using
Eq.~\eqref{eq:energy_update}.
